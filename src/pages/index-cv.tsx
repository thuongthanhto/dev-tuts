          ...
          <header>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center">
                ...
                <div className="ml-5">
                  <h1 className="text-4xl md:text-7xl font-extrabold mt-1">{data.full_name}</h1>
                  <p className="text-xl mt-1 md:mt-5 sm:ml-5">{data.title}</p>
...
export async function getStaticProps() {
  ...
  const filePath = path.join(process.cwd(), 'data', 'cv-data.json')
